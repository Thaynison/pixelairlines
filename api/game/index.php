...
<head>
    ...
    <title>Pixel Airlines - Maps</title>
  ...
  <div class="container-fluid">
    ...
    <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-dark">
              <li><a class="dropdown-item" href="../acoes/comprarAviao.php">Comprar Aviões</a></li>
              <li><a class="dropdown-item" href="../bank/bank.php">Banco do Airlines</a></li>
              <li>
        ...
        <?php if ($vip == 'Admin'): ?>
            <button class="btn btn-primary mt-3" id="salvarLocalAdmin">Salvar Aeroporto</button>
        <?php endif; ?>
...
<div class="content" style="margin-left: 0px;height: 95vh;margin-top: 50px;">
